### Properties and residential locations Reviews Sentiment Analysis | Training ###
"""
Description:
              Properties reviews sentiment analysis is a project which is based on natural language processing, where we use NLP techniques to extract useful words of each review
              and based on these words we can use binary classification to predict the property/location sentiment if it's positive or negative
"""
...
# 1.1 Load dataset
dataset = pd.read_csv('Dataset/NoBroker.csv')
...
evaluate_model(y_test, ypg, "GaussianNB")
evaluate_model(y_test, ypm, "MultinomialNB")
evaluate_model(y_test, ypb, "BernoulliNB")
